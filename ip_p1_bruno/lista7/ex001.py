...
print("\n== Programa que lê dois vetores e mostra um terceiro composto pelos outros (com elementos intercalados) ==")
...
print(f"Considerando os vetores: V1 = {v1} e V2 = {v2}, temos V3 = {v3}")